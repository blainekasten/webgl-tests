...
var transitionParams = {
  "useTexture": true,
  "transition": 0.5,
  "transitionSpeedionSpeed": 2.0,
  "texture": 5,
  "loopTexture": true,
  "animateTransitionn": true,
...
function Transition ( sceneA, sceneB, renderer ) {
  ...
  this.textures = [];
  for (var i=0;i<6;i++)
    this.textures[i]=new THREE.ImageUtils.loadTexture('textures/transition'+(i+1)+'.png');
  ...
  this.render = function( delta ) {
    ...
    if (transitionParams.transition==0) {
      ...
      console.log(this.sceneA, this.sceneB);
